...
Notify::message('09123456789', 'پیام آزمایشی')
    ->via('smsir');
...
Notify::message('09123456789', 'code: 12345, name: علی')
    ->via('smsir')
...
$response = Notify::message('09123456789', 'پیام آزمایشی')
    ->via('ippanel')
...
// ارسال:
Notify::message('09...', 'پیام')->via('mycustom')->send();
*/
